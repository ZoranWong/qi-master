 ...
 * @property string|null $note 报价留言
 ...
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Models\OfferOrder whereNote($value)
...
class OfferOrder extends Model implements HasPresenter
{
    ...
    protected $fillable = ['user_id', 'master_id', 'status', 'quote_price', 'order_id', 'order_item_id', 'note'];
    ...
    const STATUS_REFUSED_INDIRECTLY = 3;
    const STATUS = [
        self::STATUS_WAIT => '待雇佣',
        self::STATUS_HIRED => '已雇佣',
        self::STATUS_REFUSED => '被拒绝',
        self::STATUS_REFUSED_INDIRECTLY => '已雇佣其他人'
    ];
