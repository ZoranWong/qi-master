...
<div class="distance">
    <div class="max-width clearfix">
        ...
        <div class="right-content">
            <h2>修改钱包密码</h2>
            <div>
                <div class="txt-tips">为了您账户的安全，钱包密码请勿与账号密码相同</div>
                <form class="layui-form float-none profile" action="">
                    <div class="layui-form-item">
                        <label class="layui-form-label">已验证手机</label>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline modifle-phone">
                            <input type="password" name="psw" lay-verify="title" autocomplete="off"
                                   placeholder="6位钱包支付密码" class="layui-input">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">确认密码</label>
                        <div class="layui-input-inline modifle-phone">
                            <input type="password" name="psw" lay-verify="title" autocomplete="off" placeholder="再次输入密码"
                                   class="layui-input">
                        </div>
                    </div>

                    <div class="layui-form-item" id="layerDemo">
                        <button class="layui-btn inquire" data-method="offset" data-type="auto">确定</button>
                    </div>
                </form>
            </div>
